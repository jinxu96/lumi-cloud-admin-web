...
const SAMPLE_CONFIG = {
  password: '123456',
  passkeyId: '0ef08b4170600e86',
  // Replace the lines below with your actual PEM if you want to bake it in.
  publicKeyLines: [
    '-----BEGIN PUBLIC KEY-----',
    'MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDPPVtuyttgr1qIdKmCVAsHbLj//ctO29/q8rNhXG3h5TE98gqRYtF5il2xOzCJO9zukaVHPHRIthOZQfb/vxfaewzFWAr3lYs/QK/dowKIWb0V7B9bq/rqkYKmgaY/dt1xkbog03/aVxxz+wcjzyQfDf4E+85xR//yalx4xyFDNQIDAQAB',
    '-----END PUBLIC KEY-----'
  ]
};
